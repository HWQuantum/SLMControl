...
class PatternContainer(QWidget):
    ...
    def __init__(self, base_x, base_y, disable_zernike=False):
        ...
        if not self.disable_zernike:
            ...
            self.layout.addWidget(self.pattern_selector, 0, 0, 1, 3)
            self.layout.addWidget(self.pattern_control_scroll_area, 1, 0, 1, 3)
            self.layout.addWidget(self.vector_selector, 0, 3, 1, 3)
            self.layout.addWidget(self.vector_control_scroll_area, 1, 3, 1, 3)
            self.layout.addWidget(QLabel("Dimension:"), 2, 0)
            self.layout.addWidget(self.dimension, 2, 1, 1, 2)
            self.layout.addWidget(QLabel("Rotation:"), 2, 3)
            self.layout.addWidget(self.rotation, 2, 4, 1, 2)
            self.layout.addWidget(self.grating, 3, 0, 1, 2)
            self.layout.addWidget(self.position, 3, 2, 1, 2)
            self.layout.addWidget(self.scaling, 3, 4, 1, 2)
